...
export const STAGE_CONFIGS: Record<Stage, StageConfig> = {
  1: {
    ...
    modalBody:
      ...
      'אנחנו עובדים עם שני קבצים נפרדים: Teenager.java מגדיר את המחלקה — מה המתבגר יודע ויכול לעשות. Main.java ישתמש במחלקה בהמשך כדי ליצור מתבגרים בפועל.\n\n' +
      'עכשיו אנחנו ב-Teenager.java. נגדיר את השדות — המידע שכל מתבגר יחזיק. שים לב למילה private — אנחנו מגנים על הנתונים!\n\n' +
  ...
  5: {
    ...
    modalBody:
      'עכשיו עוברים לקובץ השני — Main.java.\n\n' +
      'זהו הקובץ שמשתמש במחלקה שבנינו. Teenager.java הגדיר את השרטוט; Main.java הוא התוכנית שמשתמשת בו. בג\'אווה האמיתית זה בדיוק כך: כל מחלקה בקובץ משלה, ותוכנית ראשית שמרכיבה הכל יחד.\n\n' +
      'נשתמש במילה הקסומה new כדי ליצור מתבגר אמיתי מהשרטוט. ברגע שנריץ, מתבגר חי יופיע עם כל הערכים שהגדרנו בקונסטרקטור.',
